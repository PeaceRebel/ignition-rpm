...
Provides: bundled(golang(cloud.google.com/go/storage/internal)) = 1.30.1
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2)) = 1.30.1
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2/stubs)) = 1.30.1
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/arn)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awserr)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awsutil)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client/metadata)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/corehandlers)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ec2rolecreds)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/endpointcreds)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/processcreds)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ssocreds)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/stscreds)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/csm)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/defaults)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/ec2metadata)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/endpoints)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/request)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/session)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/signer/v4)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/context)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/ini)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/arn)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/s3err)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkio)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkmath)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkrand)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkuri)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/shareddefaults)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/strings)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sync/singleflight)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/checksum)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream/eventstreamapi)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/json/jsonutil)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/jsonrpc)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query/queryutil)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/rest)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restjson)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restxml)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/xml/xmlutil)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3iface)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3manager)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso/ssoiface)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts)) = 1.44.289
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts/stsiface)) = 1.44.289
Provides: bundled(golang(github.com/beevik/etree)) = 1.2.0
Provides: bundled(golang(github.com/containers/libhvee/pkg/kvp)) = 0.2.0
...
Provides: bundled(golang(golang.org/x/net/context)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/http2)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/http2/hpack)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/http/httpguts)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/http/httpproxy)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/idna)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/internal/timeseries)) = 0.11.0
Provides: bundled(golang(golang.org/x/net/trace)) = 0.11.0
Provides: bundled(golang(golang.org/x/oauth2)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/authhandler)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/google)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/externalaccount)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/internal)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/jws)) = 0.9.0
Provides: bundled(golang(golang.org/x/oauth2/jwt)) = 0.9.0
Provides: bundled(golang(golang.org/x/sys/cpu)) = 0.9.0
Provides: bundled(golang(golang.org/x/sys/unix)) = 0.9.0
Provides: bundled(golang(google.golang.org/api/googleapi)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/googleapi/transport)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/iamcredentials/v1)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/internal)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/internal/cert)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/internal/gensupport)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/internal/impersonate)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/internal/third_party/uritemplates)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/iterator)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/option)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/option/internaloption)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/storage/v1)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/transport)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/transport/grpc)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/transport/http)) = 0.128.0
Provides: bundled(golang(google.golang.org/api/transport/http/internal/propagation)) = 0.128.0
...
%changelog
* Thu Jun 29 2023 Benjamin Gilbert <bgilbert@redhat.com> - 2.16.0-1
- New release
