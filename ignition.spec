...
%changelog
* Mon Mar 11 2024 Packit <hello@packit.dev> - 2.18.0-1
- NEWS: update 2.18.0 (Yasmin Valim)
- build(deps): bump google.golang.org/api from 0.165.0 to 0.167.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.50.20 to 1.50.25 (dependabot[bot])
- build(deps): bump cloud.google.com/go/storage from 1.37.0 to 1.38.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.50.10 to 1.50.20 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.161.0 to 0.165.0 (dependabot[bot])
- Dockerfile.validate: update to Fedora 39 (Steven Presti)
- azure: retry HTTP requests on codes 404, 410, and 429 (Jonathan Lebon)
- docs: add missing scaleway link (Mathieu Tortuyaux)
- build(deps): bump github.com/aws/aws-sdk-go from 1.50.9 to 1.50.10 (dependabot[bot])
- providers: add scaleway (Mathieu Tortuyaux)
- build(deps): bump github.com/aws/aws-sdk-go from 1.49.16 to 1.50.9 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.157.0 to 0.161.0 (dependabot[bot])
- build(deps): bump cloud.google.com/go/storage from 1.36.0 to 1.37.0 (dependabot[bot])
- build(deps): bump github.com/google/uuid from 1.5.0 to 1.6.0 (dependabot[bot])
- resource/url: customize local address (port) (Mathieu Tortuyaux)
- Sync repo templates ⚙ (CoreOS Bot)
- stages/files: filter out non-existent paths before relabeling (Jonathan Lebon)
- docs/release-notes: tweak dracut module change (Jonathan Lebon)
- build(deps): bump golang.org/x/sys from 0.15.0 to 0.16.0 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.154.0 to 0.155.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.49.14 to 1.49.16 (dependabot[bot])
- build(deps): bump github.com/containers/libhvee from 0.5.0 to 0.6.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.48.16 to 1.49.14 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.153.0 to 0.154.0 (dependabot[bot])
- build(deps): bump github.com/google/uuid from 1.4.0 to 1.5.0 (dependabot[bot])
- build(deps): bump cloud.google.com/go/storage from 1.35.1 to 1.36.0 (dependabot[bot])
- build(deps): bump github.com/beevik/etree from 1.2.0 to 1.3.0 (dependabot[bot])
- build(deps): bump golang.org/x/crypto from 0.16.0 to 0.17.0 (dependabot[bot])
- Bump minimum Go version to 1.20 (Steven Presti)
- Sync repo templates ⚙ (CoreOS Bot)
- build(deps): bump google.golang.org/api from 0.152.0 to 0.153.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.48.11 to 1.48.16 (dependabot[bot])
- build(deps): bump golang.org/x/oauth2 from 0.14.0 to 0.15.0 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.151.0 to 0.152.0 (dependabot[bot])
- build(deps): bump golang.org/x/net from 0.18.0 to 0.19.0 (dependabot[bot])
- build(deps): bump golang.org/x/sys from 0.14.0 to 0.15.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.48.4 to 1.48.11 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.48.0 to 1.48.4 (dependabot[bot])
- dracut: Don't include the ignition module by default (Fabian Vogt)
- Sync repo templates ⚙ (CoreOS Bot)
- ci: cancel previous build on PR update (Jonathan Lebon)
- build(deps): bump github.com/containers/libhvee from 0.4.0 to 0.5.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.47.9 to 1.48.0 (dependabot[bot])
