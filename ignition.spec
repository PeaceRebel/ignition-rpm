...
%changelog
* Fri Nov  24 2023 Packit <hello@packit.dev> - 2.17.0-1
- NEWS: update 2.17.0 (Yasmin Valim)
- build(deps): bump google.golang.org/api from 0.150.0 to 0.151.0 (dependabot[bot])
- packit: add initial support (Steven Presti)
- build(deps): bump cloud.google.com/go/storage from 1.34.1 to 1.35.1 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.149.0 to 0.150.0 (dependabot[bot])
- build(deps): bump golang.org/x/oauth2 from 0.13.0 to 0.14.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.47.3 to 1.47.9 (dependabot[bot])
- build(deps): bump golang.org/x/sys from 0.13.0 to 0.14.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.46.6 to 1.47.3 (dependabot[bot])
- build(deps): bump cloud.google.com/go/storage from 1.33.0 to 1.34.1 (dependabot[bot])
- Bump minimum Go version to 1.19 (Steven Presti)
- build(deps): bump google.golang.org/api from 0.147.0 to 0.148.0 (dependabot[bot])
- Add vsock modules into ramdisk (Brent Baude)
- Sync repo templates ⚙ (CoreOS Bot)
- providers/applehv: Add Apple Hypervisor (Brent Baude)
- build(deps): bump github.com/google/uuid from 1.3.1 to 1.4.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.46.1 to 1.46.6 (dependabot[bot])
- tests/blackbox: allow skipping critical logging check (Jonathan Lebon)
- stages/disks: retry `sgdisk --zap-all` invocation (Jonathan Lebon)
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.25 to 1.46.1 (dependabot[bot])
- Add optionally-installed grub2 code (Colin Walters)
- build(deps): bump google.golang.org/api from 0.145.0 to 0.147.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.24 to 1.45.25 (dependabot[bot])
- build(deps): bump golang.org/x/net from 0.15.0 to 0.17.0 (dependabot[bot])
- build(deps): bump golang.org/x/oauth2 from 0.12.0 to 0.13.0 (dependabot[bot])
- build(deps): bump golang.org/x/sys from 0.12.0 to 0.13.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.19 to 1.45.24 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.143.0 to 0.145.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.15 to 1.45.19 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.142.0 to 0.143.0 (dependabot[bot])
- internal/exec/stages/disks: prevent races with udev (Kai Lueke)
- build(deps): bump google.golang.org/api from 0.141.0 to 0.142.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.11 to 1.45.15 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.6 to 1.45.11 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.139.0 to 0.141.0 (dependabot[bot])
- build(deps): bump cloud.google.com/go/storage from 1.32.0 to 1.33.0 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.138.0 to 0.139.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.45.2 to 1.45.6 (dependabot[bot])
- build(deps): bump golang.org/x/oauth2 from 0.11.0 to 0.12.0 (dependabot[bot])
- providers/hetzner: add support for Hetzner Cloud (Manuel Hutter)
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.332 to 1.45.2 (dependabot[bot])
- build(deps): bump golang.org/x/sys from 0.11.0 to 0.12.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.327 to 1.44.332 (dependabot[bot])
- build(deps): bump github.com/google/uuid from 1.3.0 to 1.3.1 (dependabot[bot])
- Sync repo templates ⚙ (CoreOS Bot)
- build(deps): bump cloud.google.com/go/storage from 1.31.0 to 1.32.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.322 to 1.44.327 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.136.0 to 0.138.0 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.134.0 to 0.136.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.317 to 1.44.322 (dependabot[bot])
- build(deps): bump golang.org/x/oauth2 from 0.10.0 to 0.11.0 (dependabot[bot])
- build(deps): bump golang.org/x/sys from 0.10.0 to 0.11.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.312 to 1.44.317 (dependabot[bot])
- docs: expand development docs and rationale (Benjamin Gilbert)
- doc/development: list the test frameworks (Benjamin Gilbert)
- docs/development: improve formatting of blackbox section (Benjamin Gilbert)
- build(deps): bump google.golang.org/api from 0.132.0 to 0.134.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.306 to 1.44.312 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.305 to 1.44.306 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.131.0 to 0.132.0 (dependabot[bot])
- build(deps): bump github.com/containers/libhvee from 0.3.0 to 0.4.0 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.300 to 1.44.305 (dependabot[bot])
- build(deps): bump github.com/aws/aws-sdk-go from 1.44.298 to 1.44.300 (dependabot[bot])
- build(deps): bump google.golang.org/api from 0.130.0 to 0.131.0 (dependabot[bot])
- Sync repo templates ⚙ (CoreOS Bot)
